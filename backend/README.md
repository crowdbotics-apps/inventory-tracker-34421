...
## Project Structure
    ...
    ├── inventory_tracker_34421  # Django project configurations
...
1. Clone this repo and `cd inventory_tracker_34421`
...
2. Clone this repo and `cd inventory_tracker_34421`
